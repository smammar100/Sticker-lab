// Minimal Feather-style icon set used across the UI.
...
export const ClipboardIcon = ({ size = 15, className }: P) => (
  <svg {...base(size, className)}>
    <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" />
    <rect x="8" y="2" width="8" height="4" rx="1" ry="1" />
  </svg>
)
export const UploadIcon = ({ size = 15, className }: P) => (
  <svg {...base(size, className)}>
...
export const CodeIcon = ({ size = 14, className }: P) => (
  <svg {...base(size, className)}>
...
export const SearchPlusIcon = ({ size = 14, className }: P) => (
  <svg {...base(size, className)}>
    <circle cx="11" cy="11" r="8" />
    <line x1="21" y1="21" x2="16.65" y2="16.65" />
...
export const MaximizeIcon = ({ size = 14, className }: P) => (
  <svg {...base(size, className)}>
    <path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3" />
  </svg>
)
export const ResetIcon = ({ size = 13, className }: P) => (
  <svg {...base(size, className)}>
...
export const GithubIcon = ({ size = 13, className }: P) => (
  <svg {...base(size, className)}>
